...
MNet will allow you to connect your client applications to a persistent network of nodes, where you may announce services on the network, as well as send custom messages (byte arrays and/or strings) to all of or a subset of known nodes. It can also be used a simple server-client skeleton for you to manage, for example for game servers and similar applications.
